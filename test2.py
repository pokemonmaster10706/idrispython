...
#
    ...
    def switchsignup():
        ...
        userentry=CTkEntry (master=underframe, width=220, placeholder_text="Username")
        userentry.pack(pady = 15)

        passentry=CTkEntry (master=underframe, width=220, placeholder_text="Password")
        passentry.pack(pady = 15)

        repassentry=CTkEntry (master=underframe, width=220, placeholder_text="Repeat Password")
        repassentry.pack(pady = 15)
