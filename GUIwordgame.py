...
def game():
    global word, v, last, round_init, run, wordl, r, z, n
    z = 0
...
strt = tk.Label(master=game_starts,text=l[r]+' starts\n\nfirst player ' +l[r]+ ' enter a word that starts with '+last, font=('Berlin Sans FB',30))
strt.pack(padx=20, pady=25)

btn = tk.Button(game_starts, text='enter',font=('Arial', 18),command=game)
btn.pack(padx=10, pady=10)

strt = tk.Label(master=game_starts,text=l[r]+ ' enter word: ', font=('Berlin Sans FB',30))
strt.pack(padx=20, pady=25)

textbox = tk.Text(game_starts,height=1,font=('Arial',16))
textbox.pack(padx=10,pady=10)
...
#    btn.pack(padx=10, pady=10)
    ...
    strt1 = tk.Label(master=game_starts,text=l[r]+' enter word: ', font=('Berlin Sans FB',30))
